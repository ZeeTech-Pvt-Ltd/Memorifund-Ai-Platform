...
// e.g. https://x.com/MemorifundSmartUp, https://t.me/MemorifundSmartUp,
// https://youtube.com/@memorifundaiplatform
const socials = [
  {
    label: 'X (Twitter)',
    url: 'https://x.com',
    ...
    <footer className="footer">
      <div className="container">
        ...
        <div className="footer-legal" style={{ borderTop: 'none', paddingTop: 0, justifyContent: 'center' }}>
          Copyright 2026 © Memorifund Ai Platform, All Right Reserved
        </div>
      </div>
    </footer>
  )
