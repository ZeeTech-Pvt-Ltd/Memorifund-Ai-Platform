...
const KNOWN_ROUTES = ['about', 'contact', 'terms', 'privacy', 'disclosure', 'thank-you', 'how-it-works', 'memorifund-ai-platform-review-australia-scam', 'faq']
...
export default function App() {
  ...
  if (route === 'memorifund-ai-platform-review-australia-scam') return <Layout routeName="memorifund-ai-platform-review-australia-scam"><BlogArticle /></Layout>
  ...
  return (
    <Layout routeName="home">
      ...
      <CtaBanner
        ...
        text="Memorifund Ai Platform is built by a team of innovators, analysts, and engineers committed to advancing the world of automated trading. Join thousands of verified traders across Australia today."
        cta="Register Now"
      />
