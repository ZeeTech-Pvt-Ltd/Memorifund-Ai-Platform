...
// Memorifund Ai Platform-branded.
const info = [
  { icon: 'mail', title: 'Email', value: 'support@memorifund-ai-platform.com', hint: 'Replies within a few hours' },
    ...
    <>
      ...
      <section className="ct-hero">
        <div className="container ct-hero-inner reveal">
          ...
          <p className="lead">
            Have a question about Memorifund Ai Platform, your account, or automated trading? Our team is available around
      ...
      <CtaBanner
        ...
        text="Open your Memorifund Ai Platform account in minutes and put automated AI trading to work, with support available 24/7."
        cta="Register Now"
      />
    </>
  )
